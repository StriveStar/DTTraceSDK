...
/**
 ...
 不同事件类型
 */
typedef NS_ENUM(NSInteger, DTStackEventType) {
    DTSTACK_NONE = 0,
    DTSTACK_ERROR_UNCAUGHTEXCEPTION = 1, //未捕获异常，crash信息
    DTSTACK_ERROR_ONCAUGHTEXCEPTION = 2, //捕获异常专用
    DTSTACK_SYS_INSTALLED = 1001, //应用安装成功
    DTSTACK_SYS_FIRST_START = 1002, //应用第一次启动
    DTSTACK_SYS_START = 1003, //应用启动
    DTSTACK_SYS_END = 1004, //应用退出
    DTSTACK_SYS_RESTORE = 1005, //应用恢复
    DTSTACK_SYS_REGISTER = 1006, //用户注册
    DTSTACK_SYS_LOGIN = 1007, //用户登录
    DTSTACK_SYS_LOGOUT = 1008, //用户登出
    DTSTACK_SYS_FOREGROUND = 1009, //应用从后台切换前台
    DTSTACK_SYS_BACKGROUND = 1010, //应用从前台切换后台
    DTSTACK_PAGE_ENTER = 2001, //页面进入
    DTSTACK_PAGE_LEAVE = 2002, //页面离开
    DTSTACK_PAGE_CREATE = 2003, //页面创建
    DTSTACK_PAGE_DESTROY = 2004, //页面销毁
    DTSTACK_PAGE_CTL_CLICKED = 2101, //控件点击
    DTSTACK_PAGE_CTL_ITEM_SELECTED = 2102, //列表项选中
    DTSTACK_PAGE_CTL_LONG_CLICKED = 2103, //控件长按
};
...
/**
 判断该事件类型是否包含在预设置的dtstackEventType
